...
namespace SistemaPulperia.Migrations
{
    ...
    [Migration("20260304034829_HistorialContraseña")]
    partial class HistorialContraseña
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaPulperia.Web.Models.Entities.NivelAcceso", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SistemaPulperia.Web.Models.Entities.NivelAcceso", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaPulperia.Web.Models.Entities.RolMenu", b =>
                {
                    ...
                    b.HasOne("SistemaPulperia.Web.Models.Entities.NivelAcceso", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
